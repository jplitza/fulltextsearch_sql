...
namespace OCA\FullTextSearch_SQL\Settings;
...
class Admin implements ISettings {
	...
	public function getForm(): TemplateResponse {
		...
		Util::addScript(Application::APP_NAME, 'fulltextsearch_sql-settings-admin');
		Util::addStyle(Application::APP_NAME, 'fulltextsearch_sql-settings-admin');
